...
# 1.确定原图像数据集路径
dataset_dir = "D:\wendang/vscode\ObjectDetectionLearner-main\LeNet-5\data\LEDNUM/train_data/"  ##原始数据集路径
# 2.确定数据集划分后保存的路径
split_dir = "D:\wendang/vscode\ObjectDetectionLearner-main\LeNet-5\data\LEDNUM/after_train_data/"  ##划分后保存路径
